  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function AFWc(module, __webpack_exports__, __webpack_require__) {
      ...
      RepoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        pipes: [ngx_moment__WEBPACK_IMPORTED_MODULE_3__["TimeAgoPipe"]],
    ...
    function dNPv(module, __webpack_exports__, __webpack_require__) {
      ...
      var CatalogueService = /*#__PURE__*/function () {
        ...
        _createClass(CatalogueService, [{
          ...
          key: "tryLoadConfig",
          value: function tryLoadConfig(index) {
            var _this3 = this;
            ...
            var configURL = this.configURLs[index];
            this.http.get(configURL).subscribe({
              next: function next(config) {
                _this3.CONF = config; // Override with environment setting if available

                if (_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].usePreGeneratedFile !== undefined) {
                  _this3.CONF.usePreGeneratedFile = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].usePreGeneratedFile;
                }

                console.log("Loaded configuration from ".concat(configURL)); // Initialize items after config is loaded
              ...
              error: function error(_error) {
                if (_error.status === 404) {
                  console.log("Configuration file ".concat(configURL, " not found, trying next..."));

                  _this3.tryLoadConfig(index + 1);
                } else {
                  console.error("Error loading configuration from ".concat(configURL, ":"), _error);
                }
              }
            });
          }
          ...
          value: function getLocalItems(tab) {
            ...
            var _tab$org = tab.org,
                org = _tab$org === void 0 ? 'default-org' : _tab$org,
          ...
          key: "getItemsFromPreGeneratedFile",
          value: function getItemsFromPreGeneratedFile(org, topic, key) {
            var _this4 = this;

            var fileUrl = this.CONF.preGeneratedFileUrl || 'data/catalogue.json';
            return this.http.get(fileUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (data) {
              ...
              return [];
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (repos) {
              return _this4.cacheRepos(key, repos);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) {
              console.warn('Failed to fetch from pre-generated file, falling back to API', error);
              return _this4.getItemsFromAPI(org, topic, key);
            }));
          }
        }, {
          key: "getItemsFromAPI",
          value: function getItemsFromAPI(org, topic, key) {
            var _this5 = this;

            var _a, _b;

            var topicFilter = topic ? "+topic:".concat(topic) : ''; // Check if this tab should use global search

            var tab = Object.values(this.CONF.tabs).find(function (t) {
              return t.org === org && t.topic === topic;
            });
            var useGlobalSearch = (_b = (_a = tab === null || tab === void 0 ? void 0 : tab.globalSearch) !== null && _a !== void 0 ? _a : this.CONF.globalSearch) !== null && _b !== void 0 ? _b : false; // Only include org filter if not using global search

            var orgFilter = useGlobalSearch ? '' : org ? "org:".concat(org, "+") : '';
            var perPage = this.CONF.perPage;
            var totalSize = null;

            var getPage = function getPage(page) {
              return _this5.http.get("https://api.github.com/search/repositories?page=".concat(page, "&per_page=").concat(_this5.CONF.perPage, "&q=").concat(orgFilter, "fork:true").concat(topicFilter, "+sort:stars"));
            };
          ...
          key: "cacheRepos",
          value: function cacheRepos(key, repos) {
          ...
          value: function getRawReadme(repo, defaultBranch) {
            ...
            return this.http.get("https://raw.githubusercontent.com/".concat(repo, "/").concat(defaultBranch, "/README.md?time=").concat(Date.now()), {
              ...
              return _this6.http.get("https://raw.githubusercontent.com/".concat(repo, "/").concat(defaultBranch, "/.github/README.md?time=").concat(Date.now()), {
                responseType: 'text'
              }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function () {
          ...
          key: "toggleDataSource",
          value: function toggleDataSource() {
            if (this.CONF) {
          ...
          key: "setDataSource",
          value: function setDataSource(usePreGeneratedFile) {
            if (this.CONF) {
          ...
          key: "isUsingPreGeneratedFile",
          value: function isUsingPreGeneratedFile() {
            var _a;
          ...
          value: function clearCache() {
            for (var _i3 = 0, _Object$keys2 = Object.keys(this.CONF.tabs); _i3 < _Object$keys2.length; _i3++) {
              var tabKey = _Object$keys2[_i3];
              var tab = this.CONF.tabs[tabKey];
              var _tab$org2 = tab.org,
                  org = _tab$org2 === void 0 ? 'default-org' : _tab$org2,
                  _tab$topic2 = tab.topic,
                  topic = _tab$topic2 === void 0 ? '' : _tab$topic2;
              var key = "".concat(org, "-").concat(topic);
          ...
          value: function refreshItems() {
            for (var _i4 = 0, _Object$keys3 = Object.keys(this.CONF.tabs); _i4 < _Object$keys3.length; _i4++) {
      ...
      CatalogueService.ɵfac = function CatalogueService_Factory(t) {
        return new (t || CatalogueService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"]));
      };
    ...
    function l2Dm(module, __webpack_exports__, __webpack_require__) {
      ...
      var ngx_moment__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ngx-moment */
      "QUrN");
      ...
      RepoDetailsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_6__["AsyncPipe"], _pipes_emoji_fixup_pipe__WEBPACK_IMPORTED_MODULE_8__["EmojiFixupPipe"], ngx_moment__WEBPACK_IMPORTED_MODULE_9__["TimeAgoPipe"]],
    ...
    function l5KK(module, __webpack_exports__, __webpack_require__) {
      ...
      function HowtoComponent_div_29_Template(rf, ctx) {
        if (rf & 1) {
    ...
    function vY5A(module, __webpack_exports__, __webpack_require__) {
      ...
      AppRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forRoot(routes, {
          useHash: true
        }), _angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], ngx_moment__WEBPACK_IMPORTED_MODULE_4__["MomentModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_3__["FontAwesomeModule"], ngx_markdown__WEBPACK_IMPORTED_MODULE_5__["MarkdownModule"].forRoot()], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppRoutingModule, {
          imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"], _angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], ngx_moment__WEBPACK_IMPORTED_MODULE_4__["MomentModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_3__["FontAwesomeModule"], ngx_markdown__WEBPACK_IMPORTED_MODULE_5__["MarkdownModule"]],
      ...
      (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppRoutingModule, [{
          ...
          args: [{
            imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forRoot(routes, {
              useHash: true
            }), _angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], ngx_moment__WEBPACK_IMPORTED_MODULE_4__["MomentModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_3__["FontAwesomeModule"], ngx_markdown__WEBPACK_IMPORTED_MODULE_5__["MarkdownModule"].forRoot()],
            exports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]]
          }]
        }], null, null);
      })();
